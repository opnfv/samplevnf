...
#define MAX_NUM_LOCAL_MAC_ADDRESS       32
#define MAX_PORTS                       32
struct arp_cache {
        uint32_t nhip[MAX_NUM_LOCAL_MAC_ADDRESS];
...
struct arp_data {
	...
	struct ether_addr link_hw_addr[MAX_NUM_LOCAL_MAC_ADDRESS];
	uint32_t link_hw_addr_array_idx;
	uint8_t arp_cache_hw_laddr_valid[MAX_NUM_LOCAL_MAC_ADDRESS];
} __rte_cache_aligned;
