...
struct route_data *p_route_data[32];
struct nd_route_data *p_nd_route_data[32];

/**
* VNF is configured as a gateway or not.
* vnf_gateway = 0: IP Forward(default), 1:gateway
